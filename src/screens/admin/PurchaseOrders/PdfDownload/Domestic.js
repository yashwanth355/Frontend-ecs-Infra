...
const calculateAmount = (data) => {
  ...
  return data?.["purchasePriceInr"] * totalQuantity;
};
...
const ReportTable = ({ data, maximumDays, purchaseDetails }) => {
  return (
    <View style={styles.table}>
      ...
      {data.map((row, i) => (
        <View key={i} style={styles.row} wrap={false}>
          ...
          <CustomText style={styles.row2}>
            {row.description}
            <View style={styles.table}>
              <CustomText style={styles.row2}>DISPATCH QUANTITY</CustomText>
              {/* {data?.item_dispatch?.map((item, index) => ( */}
                <View style={[styles.row, styles.bold, styles.headerTable]}>
                  ...
                  <View key={i} style={styles.row} wrap={false}>
                    <CustomText style={styles.row1}>{'item.dispatch_date'}</CustomText>
                    <CustomText style={styles.row2}>{'item.dispatch_quantity'}</CustomText>
                  </View>
                </View>
              {/* ))} */}
            </View>
          ...
          <CustomText style={styles.row4}>{row.quantity}</CustomText>
          <CustomText style={styles.row5}>{row.rate}</CustomText>
          <View style={styles.row6}>
            {row.cgst ? (
              ...
              >
                ...
                <CustomText>{row.cgst}</CustomText>
              </View>
            ) : null}
            {row.sgst ? (
              <View
              ...
              >
                ...
                <CustomText>{row.sgst}</CustomText>
              </View>
            ) : null}
            {!_.isEmpty(row.igst) ? (
              <View
              ...
              >
                ...
                <CustomText>{row.igst}</CustomText>
              </View>
            ) : null}
          </View>
        ...
        >
          <View style={{ flexDirection: "row" }}>
            ...
            <View style={{ flex: 1 }}>
              ...
              >
                {numberWithCommas(
                  parseFloat(calculateGrossPrice(purchaseDetails)).toFixed(4)
                )}
              </CustomText>
            </View>
          </View>
...
const MyDocument = (props) => {
  const { purchaseDetails } = props; //documents
  return (
    <Document>
      <Page style={styles.section} size={"A4"}>
        <View style={styles.header}>
          ...
          >
            ...
            <View style={{ width: "90%" }}>
              ...
              <CustomText style={{ fontFamily: "Helvetica-Bold" }}>
                {_.upperCase(purchaseDetails?.delivery_at_gstno)}
              </CustomText>
            </View>
          </View>
          <View></View>
            ...
            data={[
              {
                ...
                unit: "KGS",
                quantity: numberWithCommas(calculateQuantity(purchaseDetails)),
                rate: numberWithCommas(
                  parseFloat(purchaseDetails?.purchasePriceInr)
                ),
                ...
                amount: numberWithCommas(
                  calculateAmount(purchaseDetails).toFixed(4)
                ),
              },
            ]}
        ...
        <View style={{ display: "flex", flexDirection: "row", width: "100%" }}>
          <View style={{ width: "40%" }}>
            ...
            >
              {_.upperCase(purchaseDetails?.billing_at_gstno)}
            </CustomText>
          </View>
