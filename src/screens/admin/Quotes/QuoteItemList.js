...
const QuoteItemList = (props) => {
  ...
  props.data && props.data.map(v => {
    rows.push(createData(v.quotelineitem_id,v.quotelineitem_number, v.quotelineitem_id, v.sample_code, v.expectedorder_kgs, v.category, v.categorytype, v.weight, v.upc_id, v.baseprice, v.final_price, v.customer_approval, v.gms_approvalstatus, v.negativemargin_status ))
  })
